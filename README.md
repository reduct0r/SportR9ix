...
Прошивка для **ESP32**: мост между **ArduPilot FrSky Passthrough** (SmartPort на наземном модуле FrSky) и **MAVLink** для **Mission Planner**. Предназначена для мониторинга полёта по радиолинии 900 MHz (R9) без прямого USB к полётному контроллеру.
...
| Компонент | Статус |
|-----------|--------|
| FrSky **R9 Slim+** / **R9 Mini** (борт) | Проверено в проекте SKAT |
